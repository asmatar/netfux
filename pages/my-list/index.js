...
function List() {
  ...
  const displayFavoriteMovies = favoriteMovies.map(movie=>(<Films key={favoriteMovies.index} films={movie}/>))
  const displayFavoriteSeries = favoriteSeries.map(movie=>(<Films key={favoriteSeries.index} films={movie}/>))
