...
/* scale version not for production */
    {/* <div className={`relative flex-col cursor-pointer h-28 min-w-[180px] md:h-36 md:min-w-[260px] hover:min-h-full`} onClick={()=>handleModal(film.id, type)}å>
