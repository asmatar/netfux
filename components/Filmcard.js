...
const FilmCard = ({film, handleModal}) => {
  ...
  return (
    <>
    <div className={`relative flex flex-col cursor-pointer transition duration-200 ease-out md:hover:scale-105 h-28 min-w-[180px] md:h-36 md:min-w-[260px] z-30`} onClick={()=>handleModal(film.id)}>
      <Image
