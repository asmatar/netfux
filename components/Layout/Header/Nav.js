...
const Nav = () => {
  ...
  return (
    <nav className="flex flex-col relative group transition-all duration-200">
        ...
        <ul className="gap-x-6 flex-col sm:relative sm:top-0 absolute top-16 right-1/2 invisible group-hover:opacity-100 opacity-0  group-hover:visible translate-x-1/2 sm:flex-row w-56 sm:flex sm:border-none sm:opacity-100 border border-t-2 border-gray-500 border-t-white transition-all duration-200">
