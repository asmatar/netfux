    ...
    <>
      <div class="modal animate-fade fixed top-0 left-0 right-0 bottom-0 w-full h-full outline-none overflow-x-hidden overflow-y-auto bg-black/60 z-50 flex items-center justify-center" onClick={() => setShowModal(false)}>
        <div className="min-w-[850px] w-[850px]">
          <div className="flex justify-center items-center min-w-[850px] w-[850px] h-[480px] rounded-t-lg overflow-hidden relative">
            ...
            <div className="absolute bottom-10 left-10 z-20 flex gap-x-2 items-center">
              ...
              <div className="relative flex flex-col gap-y-4 group">
                ...
                <button className="rounded-full border-white/60 p-2 border-2 group-hover:border-white transition duration-200 ease-out">
              ...
              <div className="relative flex flex-col gap-y-4 group">
                ...
                <button className="rounded-full border-white/60 p-2 border-2 hover:border-white transition duration-200 ease-out">
            ...
            <Button className="absolute bottom-10 right-10 cursor-pointer rounded-full border-white/60 p-2 border-2 hover:border-white transition duration-200 ease-out">
            ...
            <Button className="absolute bottom-10 right-0 cursor-pointer rounded-full border-white/60 p-2 border-2 hover:border-white transition duration-200 ease-out">
