...
const Modal = () => {
  ...
  return ReactDOM.createPortal((
    <>
      <div className=" h-[100svh] modal animate-fade fixed top-0 left-0 right-0 bottom-0 w-full  outline-none overflow-x-hidden overflow-y-auto bg-black/60 z-50 flex items-center justify-center" /* onClick={() => setShowModal(false)} */>
        <ToastContainer />  
        <div className="min-w-full w-full normal-phone:mt-0 big-phone:min-w-[85%] big-phone:w-[85%] lg:w-[850px] lg:min-w-[850px] lg:mt-4 fixed top-0 overflow-auto h-full" >
          { trailer !== undefined 
          ?
            <div className="flex justify-center items-center min-w-full w-full lg:min-w-[850px] lg:w-[850px] big-phone:h-[380px] lg:h-[480px] h-[250px] rounded-t-lg overflow-hidden relative">
              <div className="rounded-full bg-black p-2 w-min absolute top-5 right-5 cursor-pointer" onClick={handleCloseModal}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="Hawkins-Icon Hawkins-Icon-Standard"><path fillRule="evenodd" clipRule="evenodd" d="M2.29297 3.70706L10.5859 12L2.29297 20.2928L3.70718 21.7071L12.0001 13.4142L20.293 21.7071L21.7072 20.2928L13.4143 12L21.7072 3.70706L20.293 2.29285L12.0001 10.5857L3.70718 2.29285L2.29297 3.70706Z" fill="currentColor"></path></svg>
              </div>
              { trailer === "" 
              ? <Loader /> 
              :
              ...
              <div className="absolute bottom-5 sm:bottom-10 left-10 z-20 flex gap-x-2 items-center">
                ...
                <Link href={`/details/${currentPath}/${movie.id}`} className="relative flex flex-col gap-y-4 group" onClick={handleCloseModal}>
                  ...
                  <button className="rounded-full border-white/60 p-1 sm:p-2 border-2 group-hover:border-white transition duration-200 ease-out">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="Hawkins-Icon Hawkins-Icon-Standard"><path fillRule="evenodd" clipRule="evenodd" d="M11 2V11H2V13H11V22H13V13H22V11H13V2H11Z" fill="currentColor"></path></svg>
                  </button>
                </Link>
                ...
                :                         
                  <button className="rounded-full border-red-700/60 p-1 sm:p-2 border-2 hover:border-red-700 transition duration-200 ease-out absolute bottom-0 -right-14 z-50 rotate-180" onClick={() => handleRemoveFromFavorite(movie.id)}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="#d35329" xmlns="http://www.w3.org/2000/svg" className="Hawkins-Icon Hawkins-Icon-Standard"><path fillRule="evenodd" clipRule="evenodd" d="M10.696 8.7732C10.8947 8.45534 11 8.08804 11 7.7132V4H11.8377C12.7152 4 13.4285 4.55292 13.6073 5.31126C13.8233 6.22758 14 7.22716 14 8C14 8.58478 13.8976 9.1919 13.7536 9.75039L13.4315 11H14.7219H17.5C18.3284 11 19 11.6716 19 12.5C19 12.5929 18.9917 12.6831 18.976 12.7699L18.8955 13.2149L19.1764 13.5692C19.3794 13.8252 19.5 14.1471 19.5 14.5C19.5 14.8529 19.3794 15.1748 19.1764 15.4308L18.8955 15.7851L18.976 16.2301C18.9917 16.317 19 16.4071 19 16.5C19 16.9901 18.766 17.4253 18.3994 17.7006L18 18.0006L18 18.5001C17.9999 19.3285 17.3284 20 16.5 20H14H13H12.6228C11.6554 20 10.6944 19.844 9.77673 19.5382L8.28366 19.0405C7.22457 18.6874 6.11617 18.5051 5 18.5001V13.7543L7.03558 13.1727C7.74927 12.9688 8.36203 12.5076 8.75542 11.8781L10.696 8.7732ZM10.5 2C9.67157 2 9 2.67157 9 3.5V7.7132L7.05942 10.8181C6.92829 11.0279 6.72404 11.1817 6.48614 11.2497L4.45056 11.8313C3.59195 12.0766 3 12.8613 3 13.7543V18.5468C3 19.6255 3.87447 20.5 4.95319 20.5C5.87021 20.5 6.78124 20.6478 7.65121 20.9378L9.14427 21.4355C10.2659 21.8094 11.4405 22 12.6228 22H13H14H16.5C18.2692 22 19.7319 20.6873 19.967 18.9827C20.6039 18.3496 21 17.4709 21 16.5C21 16.4369 20.9983 16.3742 20.995 16.3118C21.3153 15.783 21.5 15.1622 21.5 14.5C21.5 13.8378 21.3153 13.217 20.995 12.6883C20.9983 12.6258 21 12.5631 21 12.5C21 10.567 19.433 9 17.5 9H15.9338C15.9752 8.6755 16 8.33974 16 8C16 6.98865 15.7788 5.80611 15.5539 4.85235C15.1401 3.09702 13.5428 2 11.8377 2H10.5Z" fill="#c53030"/></svg>
                  </button>
                }
                </div>
          ...
          :
            ...
            <div className="relative bg-[#181818]">
              <p className="text-center font-NetflixBold text-red-700 text-2xl  py-6 rounded">This trailer is not availiable on Youtube</p>
              <div className="rounded-full bg-black p-2 w-min absolute top-5 right-5 cursor-pointer" onClick={/* () => {setShowModal(false); setMovie(null)} */handleCloseModal}>
                ...
                <div className="flex px-10 gap-x-6">
                  <Link href={`/details/${currentPath}/${movie.id}`} className="relative flex items-center flex-col gap-y-4 group" onClick={handleCloseModal}>
                    <div className="transition-all duration-500 py-2 px-4 absolute -top-16 left-1/2 -translate-x-1/2 opacity-0 invisible group-hover:opacity-100 group-hover:visible w-max text-black rounded">
                      <p className="bg-white/80 rounded py-2 px-4">More details</p>
                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2">
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  { (sameMovie || sameSerie) === undefined 
                  ?
                    <div className="relative flex flex-col gap-y-4 group" onClick={() => handleFavorite(movie)}>
                      <div className="transition-all duration-500 py-2 px-4 absolute -top-16 left-1/2 -translate-x-1/2 opacity-0 invisible group-hover:opacity-100 group-hover:visible w-max text-black rounded">
                        <p className="bg-white/80 rounded py-2 px-4" >Add to my list</p>
                        <div className="absolute bottom-0 left-1/2 -translate-x-1/2">
                          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  :
                    <button className="rounded-full border-red-700/60 p-1 sm:p-2 border-2 hover:border-red-700 transition duration-200 ease-out z-50 rotate-180" onClick={() => handleRemoveFromFavorite(movie.id)}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="#d35329" xmlns="http://www.w3.org/2000/svg" className="Hawkins-Icon Hawkins-Icon-Standard"><path fillRule="evenodd" clipRule="evenodd" d="M10.696 8.7732C10.8947 8.45534 11 8.08804 11 7.7132V4H11.8377C12.7152 4 13.4285 4.55292 13.6073 5.31126C13.8233 6.22758 14 7.22716 14 8C14 8.58478 13.8976 9.1919 13.7536 9.75039L13.4315 11H14.7219H17.5C18.3284 11 19 11.6716 19 12.5C19 12.5929 18.9917 12.6831 18.976 12.7699L18.8955 13.2149L19.1764 13.5692C19.3794 13.8252 19.5 14.1471 19.5 14.5C19.5 14.8529 19.3794 15.1748 19.1764 15.4308L18.8955 15.7851L18.976 16.2301C18.9917 16.317 19 16.4071 19 16.5C19 16.9901 18.766 17.4253 18.3994 17.7006L18 18.0006L18 18.5001C17.9999 19.3285 17.3284 20 16.5 20H14H13H12.6228C11.6554 20 10.6944 19.844 9.77673 19.5382L8.28366 19.0405C7.22457 18.6874 6.11617 18.5051 5 18.5001V13.7543L7.03558 13.1727C7.74927 12.9688 8.36203 12.5076 8.75542 11.8781L10.696 8.7732ZM10.5 2C9.67157 2 9 2.67157 9 3.5V7.7132L7.05942 10.8181C6.92829 11.0279 6.72404 11.1817 6.48614 11.2497L4.45056 11.8313C3.59195 12.0766 3 12.8613 3 13.7543V18.5468C3 19.6255 3.87447 20.5 4.95319 20.5C5.87021 20.5 6.78124 20.6478 7.65121 20.9378L9.14427 21.4355C10.2659 21.8094 11.4405 22 12.6228 22H13H14H16.5C18.2692 22 19.7319 20.6873 19.967 18.9827C20.6039 18.3496 21 17.4709 21 16.5C21 16.4369 20.9983 16.3742 20.995 16.3118C21.3153 15.783 21.5 15.1622 21.5 14.5C21.5 13.8378 21.3153 13.217 20.995 12.6883C20.9983 12.6258 21 12.5631 21 12.5C21 10.567 19.433 9 17.5 9H15.9338C15.9752 8.6755 16 8.33974 16 8C16 6.98865 15.7788 5.80611 15.5539 4.85235C15.1401 3.09702 13.5428 2 11.8377 2H10.5Z" fill="#c53030"/></svg>
                    </button>
                  }
                </div>
